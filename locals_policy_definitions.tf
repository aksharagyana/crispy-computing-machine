...
#  custom_policy_definitions_from_json  =  tolist(fileset(local.custom_library_path, "**/policy_definition_*.{json,json.tftpl}"))
#  custom_policy_definitions_from_yaml  =  tolist(fileset(local.custom_library_path, "**/policy_definition_*.{yml,yml.tftpl,yaml,yaml.tftpl}"))
}
